"""Assemble a training folder for laya_turbo.cuda.lora from teacher output plus a general replay.
    ...
    python scripts/build_train.py --teacher data/teacher/train.jsonl --test data/teacher/test.jsonl \
...
shares), plus a replay of human-labelled items from openly licensed datasets (no templated
...
def main() -> None:
    ...
    teacher = teacher_items(args.teacher)
    replay = [
